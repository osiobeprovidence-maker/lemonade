  ...
  return (
    <div className="space-y-5">
      <div className="space-y-2">
        ...
        <h2 className="text-3xl font-black tracking-tight text-zinc-950">Sign up</h2>
        <p className="text-sm leading-6 text-zinc-500">Create your account without leaving the page.</p>
      </div>
      ...
      <div className="space-y-3">
        <button
          ...
          disabled={loading}
          className="flex w-full items-center justify-center gap-3 rounded-xl border border-zinc-300 px-4 py-3.5 text-sm font-semibold text-zinc-900 transition hover:border-zinc-900 hover:bg-zinc-50 disabled:cursor-not-allowed disabled:opacity-60"
        >
